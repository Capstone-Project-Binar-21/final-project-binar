    ...
    <div className=" flex flex-col lg:flex-row w-full min-h-screen">
      ...
      <div className="bg-white p-8 lg:p-16 lg:w-2/3 flex items-center justify-center    overflow-hidden">
        <div className="w-full lg:w-2/3 text-black">
          <h1 className="font-bold text-[28px] text-darkBlue05 lg:mb-12 text-left">
            Masuk
          </h1>
          ...
          <div className="mt-2 relative block mb-4 lg:mb-8">
            ...
            <p className="float-right">
              <a
                ...
                className="text-darkBlue05 font-medium"
              >
                Lupa Kata Sandi
              </a>
            </p>
          ...
          <p className="text-black items-center text-center mt-6">
            Belum punya akun?{" "}
            <a href="/" className="text-darkBlue05 font-bold">
              Daftar di sini
            </a>
          </p>
      ...
      {/* Bagian Kanan */}
      <div className="bg-darkBlue05 p-8 lg:p-16 w-full lg:w-[45%] h-[100vh] flex items-center justify-center">
        <img
